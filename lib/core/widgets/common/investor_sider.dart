...
class InvestorSider extends StatefulWidget {
  ...
  @override
  State<InvestorSider> createState() => _InvestorSiderState();
}
...
class _InvestorSiderState extends State<InvestorSider> {
    ...
    return Drawer(
      ...
      child: Row(
        children: [
          ...
          Expanded(
            flex: 4, // Adjust this ratio to match the blue area in your image
            child: Container(
              ...
              child: SafeArea(
                child: Column(
                  children: [
                    ...
                    // Navigation List
                    _buildNavTile(Icons.home_outlined, 'Home', '/home'),
                    _buildNavTile(Icons.grid_view_rounded, 'Dashboard', '/dashboard'),
                    _buildNavTile(Icons.info_outline, 'About Us', '/about'),
                    _buildNavTile(Icons.phone_outlined, 'Contact Us', '/contact'),
                    _buildNavTile(Icons.description_outlined, 'Terms Of Service', '/terms'),
  ...
  Widget _buildNavTile(IconData icon, String label, String route) {
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color: isActive ? const Color(0xFF3D41AC) : Colors.transparent,
    ...
    return Column(
      children: [
        ListTile(
          ...
          leading: const Icon(Icons.cached, color: Colors.black87),
          title: const Text(
            'Switch Role',
            style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16),
          ),
          trailing: Icon(_isRoleExpanded ? Icons.expand_less : Icons.expand_more),
        ),
        if (_isRoleExpanded) ...[
    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: Text(
          label,
          style: TextStyle(
            color: isActive ? const Color(0xFF3D41AC) : Colors.black54,
  ...
  Widget _buildDeleteButton() {
    return ElevatedButton.icon(
      onPressed: () {}, // Logic for deletion
      icon: const Icon(Icons.person, color: Colors.white),
      label: const Text('Delete', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
