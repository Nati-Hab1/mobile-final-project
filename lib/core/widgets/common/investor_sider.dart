...
class InvestorSider extends ConsumerStatefulWidget {
  final String role;
  ...
  @override
  ConsumerState<InvestorSider> createState() => _InvestorSiderState();
}

class _InvestorSiderState extends ConsumerState<InvestorSider> {
              ...
              child: SafeArea(
                child: Column(
                  children: [
                    ...
                    _buildNavTile(context, activePath,
                        Icons.grid_view_rounded, 'Dashboard', '/investor-dashboard'),
                    _buildNavTile(context, activePath,
