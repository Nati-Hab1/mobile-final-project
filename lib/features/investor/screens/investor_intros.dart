...
class InvestorIntrosPage extends StatefulWidget {
  ...
  @override
  State<InvestorIntrosPage> createState() => _InvestorIntrosPageState();
}

class _InvestorIntrosPageState extends State<InvestorIntrosPage> {
                            ...
                            Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  const Text("Founder: John smith"),
                                  const Text("Email: johnsmith@gmail.com"),
                                  const SizedBox(height: 16),
