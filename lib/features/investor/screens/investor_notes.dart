...
class InvestorNotes extends StatefulWidget {
  ...
  @override
  State<InvestorNotes> createState() => _InvestorNotesState();
}

class _InvestorNotesState extends State<InvestorNotes> {
  final TextEditingController _noteController = TextEditingController(
    text: "I wanted to check this idea later as it caught my attention and i think its a good idea.\n\ndate: 12/01/2025",
  );

void _showSavedDialog() {
  showDialog(
    context: context,
    barrierColor: const Color.fromARGB(255, 232, 230, 230).withOpacity(0.3), // slight dark overlay
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            _buildMiniAction(Icons.copy_outlined, "Copy"),
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      Expanded(
                        child: ElevatedButton(
                          onPressed: _showSavedDialog, // Triggers image_0350fb.png popup
                          style: ElevatedButton.styleFrom(
